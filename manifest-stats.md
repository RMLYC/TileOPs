...
![ops](https://img.shields.io/badge/ops-175-blue) ![implemented](https://img.shields.io/badge/implemented-162%20%2F%20175%20%2893%25%29-brightgreen) ![spec--only](https://img.shields.io/badge/spec--only-13-orange)
...
| --- | ---: |
| `ref_api` | 175 / 175 (100%) |
| `roofline` (func or flops+bytes) | 175 / 175 (100%) |
| `source.kernel_map` | 168 / 175 (96%) |
| `source.bench_manifest_driven` | 162 / 175 (93%) |

**Workloads:** 632 total — 3.72 per implemented op.
